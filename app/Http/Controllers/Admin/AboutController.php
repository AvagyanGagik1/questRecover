...
use App\Http\Requests\About\StoreUpdateAboutRequest;
...
class AboutController extends Controller
{
    ...
    {
        $response = new CreateUi(About::getModel());
     ...
     *
     * @param StoreUpdateAboutRequest $request
     * @param int $id
     * @return RedirectResponse
     */
    public function update(StoreUpdateAboutRequest $request, int $id): RedirectResponse
    {
        $input = $request->all();
        $files = $this->getFile($request);
