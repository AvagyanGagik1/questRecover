...
use App\Http\Requests\Team\StorePositionRequest;
use App\Http\Requests\Team\StoreUpdatePositionRequest;
...
class PositionController extends Controller
{
    ...
    {
        $response = new CreateUi(Position::getModel());
    ...
    {
        $response = new CreateUi(Position::getModel());
        $model = Position::find($id)->toArray();
     ...
     * @return RedirectResponse
     */
    public function update(StoreUpdatePositionRequest $request, int $id): RedirectResponse
    {
        $input = $request->all();
        $files = $this->getFile($request);
