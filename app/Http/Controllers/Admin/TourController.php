...
use App\Http\Requests\Tour\StoreUpdateTourRequest;
use App\Models\Tour;
...
class TourController extends Controller
{
    ...
    {
        $response = new CreateUi(Tour::getModel());
     ...
     *
     * @param StoreUpdateTourRequest $request
     * @param int $id
     * @return RedirectResponse
     */
    public function update(StoreUpdateTourRequest $request, int $id): RedirectResponse
    {
        $input = $request->all();
        $files = $this->getFile($request);
